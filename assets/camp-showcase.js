(function () {
  ...
  var STEP_ORDER = ['dashboard', 'outbound', 'inbound', 'wizard', 'operations'];
  var labels = {'dashboard': 'Campaign Command Center', 'outbound': 'Outbound Campaigns', 'inbound': 'Inbound Campaigns', 'wizard': 'Five-Step Guided Wizard', 'operations': 'Live Campaign Control'};
  var detailMap = {'camp-dashboard': 'dashboard', 'camp-outbound': 'outbound', 'camp-inbound': 'inbound', 'camp-wizard': 'wizard', 'camp-operations': 'operations'};
  ...
  function init() {
    ...
    function setHubActive(step, scrollCard) {
      ...
      if (metricEl) {
        ...
        metricEl.innerHTML = '<strong>' + (idx + 1) + '</strong> / 5 steps';
      }
    }
